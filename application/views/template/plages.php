     ...
     <div class="row ">
                ...
                <div class="col-sm-3">
                        ...
                        <select class="form-control Cycle" id="sel1" style="width:  70%; float: "><option id='nul'>Choisir le cycle</option>
                        ...
                        <br>
                          ...
                          <label for="sel1" >Mention:</label>&nbsp;
                             ...
                             <select class="form-control Mention" id="sel1" style="width:  70%; float: "><option id='nul' >Choisir la mention</option>
...
<div class="col-sm-9 ">
          ...
          <h6 class="m-0 font-weight-bold text-primary" style="font-size: 20px;" align="center">
           ...
           <div class="row ">
              <div class="col-sm-12 showback pp" style="height:250px; background-color: white">
          ...
          <div class="col-sm-12 showback " style="margin-top: 20px;">
                <div class="card-header py-3" align="center">
              <h6 class="m-0 font-weight-bold text-primary" style="font-size: 20px;">
           Liste additive</h6>
            </div></br>

          <div class="col-sm-12 showback liste_ajout" style=" background-color: white">
                     
                         </div>
                       </br></br></br></br></br>
          <div class="card-header py-3" align="center">
              <h6 class="m-0 font-weight-bold text-primary" style="font-size: 20px;">
            Espace de création des plages
          </h6>
            </div></br>
          
          
               <div class="col-sm-12 showback" style=" background-color: white">  
    ...
    $debut="<?php 
              ...
              foreach ($num_semaine as $row) {
                  ...
                  foreach ($num_semaine as $row) {
                   ...
                   ?>";
    $id_mention=$("select.Cycle").children(".Cycle option:selected").attr('id');
          ...
          $(".Parcour").change(function(){
           ...
           for (var i = 0; data.niv.length - 1 >= i; i++) {
             $("select.Niveau").append("<option id="+data.niv[i].id_niv_par+">"+ data.niv[i].rendu+"</option>");
              $("select#PN").append("<option id="+data.niv[i].id_niv_par+">"+ data.niv[i].rendu+"</option>");
