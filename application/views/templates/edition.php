                                      ...
                                      if (oui) {
                                        ...
                                        $(".n_edit").empty();
                                            ...
                                            $.ajax({
                                                        ...
                                                        url: "<?php  echo base_url();?>" + "Enregistrement/modification" ,
                                                        type: "POST",
                                                        //async: false,
  ...
  var tableau_jour=["Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi"];
       ...
       celulle="<tr><th style='' width='100px'></th>";
                                  ...
                                  for (var i = 0; i < 6 ; i++) {
                                     ...
                                     celulle+="<tr style='table-layout: fixed; border: 0.1em solid '><th style='' width='100px'><center>"+tableau_jour[i]+"</center></th>";
  ...
  $("#pre").css('background-color','blue');
                 ...
                 <div class=" col-sm-12 form-group choixPN showback" style="display: flex;
                                                    ...
                                                    <?php foreach ($cycles as $row) {
                                                      ...
                                                      <button type="submit" class="btn" id="choix_ok" style=" background-color: green;"><span style="color: white">OK</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                      <button type="submit" class="btn" id="pre" style=" background-color: green;"><span style="color: white">Precedent</span></button>&nbsp;
                                                      <button type="submit" class="btn" id="edit" style=" background-color: green;"><span style="color: white">Nouvel edttion</span></button>&nbsp;
                                                       
                                                      </div>

   <div class="container col-sm-12  preced showback" style="margin-top: 20px;">
  
  
</div>

                <div class=" col-sm-12  n_edit showback" style=" margin-top: 20px;">
                    ...
                    <div class="header_emploi" style="margin-top:30px; margin-left: 0px;">
                                 <div class="row ">
                                           ...
                                           <div class="col-sm-3">
                                                      <table   class="" style="table-layout: fixed; border: 0.1em  "    id="" width="87%" height="50%" cellpadding="1" cellspacing="-20">
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="" id=""><select class="form-control Semestre" id="" style=" float: right;height: 35px ; width:100%" >
                                                                </select></td> 
                                              
                                                            </tr>
                                                            <tr>
                                                                <td class="" id="" ><p align="right" style="padding-top: 10px">Semaine</p></td>
                                                                <td class="" id=""> <select class="form-control sem" id="sel1" style=" float: right; height: 35px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                <td class="" id="" colspan="2" ><select class="form-control  periode" id="periode" style=" float: right; height: 35px;width: 200px"></tr>
                                                                <option id=""></option>
                                        ...
                                        <table   class="table" style="table-layout: fixed; border: 0.1em  " id="table" width="100%">
                                          
                                          
                                        </table>
                              <button type="submit" class="btn btn-primary top" id="Imprimer" style="float: right; ">Enregistrer</button>
