               ...
               $tableau[$t]=null;   
                  ...
                  echo "<table cellpadding='1px'   align='center' style='width: 100% ; table-layout: fixed; border:0px 0px 0px 0px solid black; margin-top:10px;'><tr><th style=' width: 7%' width='100px'></th>";
                     ...
                     for ( $i = 0; $i < 6 ; $i++) {
                                     ...
                                     echo"<tr style='table-layout: fixed; border: 0.1em solid ' ><th  style='height: 9%; width: 7%' rowspan=0><center>".$tableau_jour[$i]."</center></th>";

                                     for ( $j = 0; $j < count($tableau)-1 ; $j++) {
                                            
                                          if ($i==0) {
                                            if($tableau[$j][0]=="cour"){
                                            echo "<td class='td' style='table-layout:table-layout: fixed; border: 0.1em solid;
                                             padding-top:-15px; padding-bottom:-15px; padding-left:2px; padding-right:2px;
                                             ,'  colspan=0> <font size='1'><p align='center' style='font-size:8;line-height:13px; letter-spacing:0.75px; font-familly: algerian;'>";
                        foreach ( $planifications as $value) {
                           ...
                           if ($value->type_planing=="Cour") {
                            ...
                            if ($value->groupe!=0) {
                            echo "<br><br><b style='float: left;'>".$value->salle_id."</b>
                          ";
                             echo "<font size='2'><i size=5>Groupe ".$value->groupe."</i></font>";
                            
                            if ($value->heure_definit==0) {
                             
                              echo "<b style='float: right;'>".$value->evolution."/".$value->heure."</b>";
                            }
                            else{
                              echo "<b style='float: right;'>".$value->evolution."/".$value->heure_definit."</b>";
                            }
                              ...
                              echo "<br><b style='float: left;'>".$value->salle_id."</b>".$espace."<b style='float: right;'>".$value->evolution."/".$value->heure."</b>";
                            }
                            else{
                              echo "<br><b style='float: left;'>".$value->salle_id."</b>".$espace."<b style='float: right;'>".$value->evolution."/".$value->heure_definit."</b>";
                            }
